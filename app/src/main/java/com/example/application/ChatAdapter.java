...
public class ChatAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View vi = convertView;
        if (convertView == null)
            vi = inflater.inflate(R.layout.receive_layout, null);
        ...
        if (message.isMine) {
            layout.setBackgroundResource(R.drawable.reveive_design);
            parent_layout.setGravity(Gravity.RIGHT);
        }
        // If not mine then align to left
        else {
            layout.setBackgroundResource(R.drawable.send_design);
