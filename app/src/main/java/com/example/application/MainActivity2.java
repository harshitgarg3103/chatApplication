...
public class MainActivity2 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        chatAdapter = new ChatAdapter(MainActivity2.this, chatlist);
    ...
    public void sendTextMessage(View v) {
        ...
        if (!message.equalsIgnoreCase("")) {
            ...
            CommonMethods commonMethods = new CommonMethods(MainActivity2.this);
                ...
                new Handler(Looper.getMainLooper()) {
                            ...
                            public void run() {
                                try {
                                    ...
                                    MyService.xmpp.fileTransfer(receiverUser + "@harshit-SVE15113CN/Smack", bitmap, getFileName(selectedImage));
